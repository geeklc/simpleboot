...
/**
 * 实体中属性的有效性验证，参考：<br>
 * http://hibernate.org/validator/documentation/getting-started/ <br>
 * http://beanvalidation.org/
 * @Author : lichong
 * @Date : 2022-03-06
 * @Modified By
 */
public abstract class UtilValidator {

    public static Validator VALIDATOR ;

    public static final String INVALID_MSG_TEMPLATE = "%s %s %s" ;
    ...
    public static <S> List<String> getInvalidMsg(Set<ConstraintViolation<S>> constraintViolations ){
        ...
        for (ConstraintViolation<S> constraintViolation : constraintViolations) {
            invalidMsg.add( String.format( INVALID_MSG_TEMPLATE , constraintViolation.getRootBeanClass().getName() ,
